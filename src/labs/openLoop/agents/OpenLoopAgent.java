    ...
    extends Agent
{
                                            ...
                                            HistoryView history)
	{
        ...
        for(Integer ResourceNodeId : state.getAllResourceIds())
        {  
            ResourceNodeIds.add(ResourceNodeId);
        }

        goldResourceNodeId = ResourceNodeIds.iterator().next();
                                           ...
                                           HistoryView history)
    {
        ...
        if (goldnorth > 0){
            ...
            goldnorth--;
        } else if (state.getResourceNode(goldResourceNodeId) != null) {
